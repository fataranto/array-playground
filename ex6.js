...
let resultado = countries.filter(v => v.currencyName == "EURO"); // TODO: Crea un nuevo array todos los paises que que usan el 'EURO' como mondeda
...
let pokemonsHada = pokemons.filter(v => v.typeList.includes("Fairy")) // TODO: Crea un nuevo array con todos los pokemons que son del tipo 'Fairy'
